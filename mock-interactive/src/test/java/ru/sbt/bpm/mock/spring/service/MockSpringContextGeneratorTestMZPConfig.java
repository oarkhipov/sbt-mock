...
public class MockSpringContextGeneratorTestMZPConfig extends AbstractTestNGSpringContextTests {
	...
	public void testGettingData () throws JAXBException {
		...
		assertEquals(actual, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
		                     ...
		                     + "   </bean>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterSaIn_channel\"/>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterSaOut_channel\"/>\n"
		                     + "   <jms:inbound-gateway request-destination=\"jmsQPrometheusJupiterSaIn_queue\"\n"
		                     ...
		                     + "\"/>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterRegIn_channel\"/>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterRegOut_channel\"/>\n"
		                     + "   <jms:outbound-gateway id=\"jmsQPrometheusJupiterSaCf_jmsout\"\n"
		                     ...
		                     + "   </bean>\n"
		                     + "   <jms:inbound-gateway request-destination=\"jmsQPrometheusJupiterRegIn_queue\"\n"
		                     ...
		                     + "\"/>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterResponse_channel\"/>\n"
		                     + "   <int:channel id=\"jmsQPrometheusJupiterRequest_channel\"/>\n"
		                     + "   <jms:outbound-gateway id=\"jmsQPrometheusJupiterRegCf_jmsout\"\n"
		                     ...
		                     + "   </bean>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusCrmIn_channel\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusCrmOut_channel\"/>\n"
		                     + "   <jms:inbound-gateway request-destination=\"jmsEsbPrometheusCrmIn_queue\"\n"
		                     ...
		                     + "   <int:channel id=\"jmsEsbPrometheusCrmResponse_channel\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusCrmRequest_channel\"/>\n"
		                     + "   <jms:outbound-gateway id=\"jmsEsbPrometheusCrmCf_jmsout\"\n"
		                     ...
		                     + "   </bean>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusAsyncIn_channel\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusAsyncOut_channel\"/>\n"
		                     + "   <jms:inbound-gateway request-destination=\"jmsEsbPrometheusAsyncIn_queue\"\n"
		                     ...
		                     + "\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusAsyncRequest_channel\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusAsyncResponse_channel\"/>\n"
		                     + "   <jms:outbound-gateway id=\"jmsEsbPrometheusAsyncCf_jmsout\"\n"
		                     ...
		                     + "   </bean>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusMdMIn_channel\"/>\n"
		                     + "   <int:channel id=\"jmsEsbPrometheusMdMOut_channel\"/>\n"
		                     + "   <jms:inbound-gateway request-destination=\"jmsEsbPrometheusMdMIn_queue\"\n"
		                     ...
		                     + "   <jms:outbound-gateway id=\"jmsEsbPrometheusMdMCf_jmsout\"\n"
		                     + "                         request-channel=\"jmsEsbPrometheusMdMIn_channel\"\n"
		                     + "                         reply-channel=\"jmsEsbPrometheusMdMOut_channel\"\n"
		                     + "                         receive-timeout=\"30000\"\n"
		                     + "                         reply-timeout=\"30000\"\n"
		                     ...
		                     + "      <int:mapping value=\"jms/Q.PROMETHEUS.JUPITER-REG.CF_jms/Q.PROMETHEUS.JUPITER-REG"
		                     + ".OUT\"\n"
		                     ...
		                     + "   </int:router>\n"
		                     + "   <int:service-activator output-channel=\"jms/Q.PROMETHEUS.JUPITER-SA.OUT\"\n"
		                     ...
		                     + "      <int:mapping value=\"jms/Q.PROMETHEUS.JUPITER-REG.CF_jms/Q.PROMETHEUS.JUPITER"
		                     + ".RESPONSE\"\n"
		                     ...
		                     + "   <int:service-activator output-channel=\"jms/Q.PROMETHEUS.JUPITER-REG.OUT\"\n"
		                     ...
		                     + "   <int:service-activator output-channel=\"jms/ESB.PROMETHEUS.CRM.OUT\"\n"
		                     ...
		                     + "   <int:service-activator output-channel=\"jms/ESB.PROMETHEUS.ASYNC.OUT\"\n"
		                     ...
		                     + "   <int:service-activator output-channel=\"jms/ESB.PROMETHEUS.MDM.OUT\"\n"
