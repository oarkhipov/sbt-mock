...
<xsl:stylesheet xmlns:amrct="http://sbrf.ru/NCP/AMRLIRT/CommonTypes/"
                xmlns:tns="http://sbrf.ru/NCP/AMRLIRT/ConfirmRatingRs/"
                xmlns:rsd="http://sbrf.ru/NCP/AMRLIRT/ConfirmRatingRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   ...
   <xsl:param name="dataFileName" select="'../../data/AMRLiRT/xml/ConfirmData.xml'"/>
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap-env:Envelope">
      ...
      <xsl:element name="soap-env:Envelope">
         ...
         <soap-env:Body>
            <xsl:call-template name="ConfirmResponse">
