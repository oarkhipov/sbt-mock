...
<xsl:param name="correlation-id" select="null"/>
   ...
   <!--local-name=$xsdTagsToImport base complexType - complexTypehttp://sbrf.ru/NCP/AMRLIRT/ConfirmRatingRs/-http://sbrf.ru/NCP/AMRLIRT/--><xsl:template name="confirmRatingRs">
