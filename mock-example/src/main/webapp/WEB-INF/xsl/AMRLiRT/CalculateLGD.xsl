...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap:Envelope">
      ...
      <xsl:element name="soap:Envelope">
         <xsl:call-template name="NCPHeader">
            ...
            <xsl:with-param name="operation-name" select="string('SrvCalcLGD')"/>
         ...
         <soap:Body>
            <xsl:call-template name="SrvCalcLGD">
   ...
   <!--xsd:complexType - template :LgdCalculationResponse--><!--local-name=$xsdTagsToImport base complexType - complexTypehttp://sbrf.ru/NCP/AMRLIRT/CalculateLGDRs/-http://sbrf.ru/NCP/AMRLIRT/--><xsl:template name="SrvCalcLGD">
