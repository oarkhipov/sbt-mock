...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   ...
   <xsl:param name="dataFileName"
              select="'../../data/AMRLiRT/xml/LgdFinalizationData.xml'"/>
...
<xsl:param name="correlation-id" select="null"/>
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:call-template name="NCPHeader">
                  ...
                  <xsl:with-param name="operation-name" select="string('LgdFinalizationResponse')"/>
   ...
   <xsl:template name="LgdFinalizationResponse">
      ...
      <xsl:param name="data"/>
      <xsl:element name="AMRLiRT:LgdFinalizationResponse">
         <tns:errorCode>
