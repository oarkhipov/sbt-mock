...
<xsl:stylesheet xmlns:amrct="http://sbrf.ru/NCP/AMRLIRT/CommonTypes/"
                xmlns:tns="http://sbrf.ru/NCP/AMRLIRT/CorrectRatingRs/"
                xmlns:rsd="http://sbrf.ru/NCP/AMRLIRT/CorrectRatingRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   ...
   <xsl:param name="dataFileName" select="'../../data/AMRLiRT/xml/CorrectData.xml'"/>
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap-env:Envelope">
      ...
      <xsl:element name="soap-env:Envelope">
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:call-template name="NCPHeader">
                  ...
                  <xsl:with-param name="operation-name" select="string('CorrectResponse')"/>
         ...
         <soap-env:Body>
            <xsl:call-template name="CorrectResponse">
   ...
   <xsl:template name="CorrectResponse">
      <xsl:param name="response"/>
      <xsl:param name="data"/>
      <xsl:element name="AMRLiRT:CorrectResponse">
