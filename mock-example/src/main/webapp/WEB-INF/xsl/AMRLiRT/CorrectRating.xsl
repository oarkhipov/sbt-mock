...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name"
              select="//*[local-name()='Envelope' and namespace-uri()='http://sbrf.ru/NCP/esb/envelope/']/*[local-name()='Body' and namespace-uri()='http://sbrf.ru/NCP/esb/envelope/']/*[local-name()='calculateDCRq' and namespace-uri()='http://sbrf.ru/NCP/AMRLIRT/']/*[local-name()='siebelMessage' and namespace-uri()='http://sbrf.ru/NCP/AMRLIRT/CorrectRatingRq/']/text()"/>
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap:Envelope">
      ...
      <xsl:element name="soap:Envelope">
         ...
         <soap:Body>
            <xsl:call-template name="correctRatingRs">
