...
<xsl:param name="correlation-id" select="null"/>
   ...
   <!--xsd:complexType - template :FinReportImportResponse--><!--local-name=$xsdTagsToImport base complexType - complexTypehttp://sbrf.ru/NCP/FinRep/ImportFinReportRs/1.03/-http://sbrf.ru/NCP/FinRep/--><xsl:template name="importFinReportRs">
