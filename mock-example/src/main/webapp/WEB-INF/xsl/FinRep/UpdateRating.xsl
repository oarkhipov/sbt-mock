...
<xsl:stylesheet xmlns="http://sbrf.ru/NCP/ASFO/UpdateRatingRs/"
                xmlns:tns="http://sbrf.ru/NCP/ASFO/UpdateRatingRs/"
                xmlns:rsd="http://sbrf.ru/NCP/ASFO/UpdateRatingRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name" select="//soap:Body/*//*[local-name()='status'][1]/text()"/>
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap:Envelope">
      ...
      <xsl:element name="soap:Envelope">
         ...
         <soap:Body>
            <xsl:call-template name="UpdateRatingResponse">
