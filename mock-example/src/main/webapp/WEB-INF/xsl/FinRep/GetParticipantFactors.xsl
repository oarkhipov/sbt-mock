<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/finrep/10"
                xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/"
                xmlns:rsd="http://sbrf.ru/prpc/finrep/GetParticipantFactorsRs/10/Data"
    ...
    <xsl:param name="dataFileName" select="'../../data/FinRep/xml/GetParticipantResponseData.xml'"/>
    ...
    <xsl:template match="soap-env:Envelope">
        ...
        <xsl:element name="soap-env:Envelope">
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:call-template name="NCPHeader">
                        ...
                        <xsl:with-param name="operation-name" select="string('getParticipantFactorsRs')"/>
            ...
            <soap-env:Body>
                <xsl:call-template name="getParticipantFactorsRs">
    ...
    <xsl:template name="getParticipantFactorsRs">
        <xsl:param name="response"/>
        <xsl:param name="data"/>
        <xsl:element name="getParticipantFactorsResp">
