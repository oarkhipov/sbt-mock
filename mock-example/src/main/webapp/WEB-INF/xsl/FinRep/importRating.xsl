...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="soap:Envelope">
      ...
      <xsl:element name="soap:Envelope">
         <xsl:call-template name="NCPHeader">
            ...
            <xsl:with-param name="operation-name" select="string('SrvGetRatingsAndFactors')"/>
         ...
         <soap:Body>
            <xsl:call-template name="SrvGetRatingsAndFactors">
   ...
   <!--xsd:complexType - template :ImportRatingResponse--><!--local-name=$xsdTagsToImport base complexType - complexTypehttp://sbrf.ru/NCP/FinRep/ImportRatingRs/1.03/-http://sbrf.ru/NCP/FinRep/--><xsl:template name="SrvGetRatingsAndFactors">
