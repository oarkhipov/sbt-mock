...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/NCP/CRM/ForceSignalRq/1.07/"
                xmlns:rsd="http://sbrf.ru/NCP/CRM/ForceSignalRq/1.07/forceSignalRq/Data/"
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template name="ForceSignalOfActionClientService">
      ...
      <xsl:element name="CRM:forceSignalRq">
         <tns:dealID>
            <xsl:value-of select="$data/rsd:request[@name=$request]/rsd:dealID"/>
         </tns:dealID>
         <tns:dealBPMID>
            <xsl:value-of select="$data/rsd:request[@name=$request]/rsd:dealBPMID"/>
         </tns:dealBPMID>
