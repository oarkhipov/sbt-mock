...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/"
                xmlns:rsd="http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/prtspRs/Data/"
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <!--xsd:complexType - template http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/:OperationStatus--><xsl:template match="rsd:operationStatus">
   ...
   <!--xsd:complexType - template http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/:Rating--><xsl:template match="rsd:ratings">
   ...
   <!--xsd:complexType - template http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/:ParticipantsGroup--><xsl:template match="rsd:participantsGroup">
   ...
   <!--xsd:complexType - template http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/:GroupInfo--><xsl:template match="rsd:groupInfo">
   ...
   <!--xsd:complexType - template http://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/:Participant--><xsl:template match="rsd:participants">
      <tns:participants><!--xsd:element - Inside--><tns:participantID>
         ...
         <!--xsd:element - Inside--><xsl:if test="./rsd:industry">
            <tns:industry>
   ...
   <!--xsd:complexType - template :PrtspRs--><!--local-name=$xsdTagsToImport base complexType - complexTypehttp://sbrf.ru/NCP/CRM/GetParticipantsRs/1.12/-http://sbrf.ru/NCP/CRM/--><xsl:template name="GetParticipantsOfCreditDeal">
