...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/NCP/CRM/UpdateDealRq/1.18/"
                xmlns:rsd="http://sbrf.ru/NCP/CRM/UpdateDealRq/1.18/updateDealRq/Data/"
...
<xsl:param name="correlation-id" select="null"/>
   ...
   <xsl:template match="rsd:financingInfo">
      <tns:financingInfo>
         ...
         <xsl:if test="./rsd:interestRateType">
            <tns:interestRateType>
               <xsl:value-of select="./rsd:interestRateType"/>
            </tns:interestRateType>
         </xsl:if>
         <xsl:if test="./rsd:interestRateOrder">
   ...
   <xsl:template match="rsd:productInfo">
      <tns:productInfo>
         ...
         <xsl:if test="./rsd:anotherInterestPaymentOrder">
            <tns:anotherInterestPaymentOrder>
               <xsl:value-of select="./rsd:anotherInterestPaymentOrder"/>
            </tns:anotherInterestPaymentOrder>
         </xsl:if>
         <tns:refinancing>
   ...
   <xsl:template match="rsd:deal">
      <tns:deal>
         ...
         <xsl:if test="./rsd:baseCurrency">
            <tns:baseCurrency>
               <xsl:value-of select="./rsd:baseCurrency"/>
            </tns:baseCurrency>
         </xsl:if>
