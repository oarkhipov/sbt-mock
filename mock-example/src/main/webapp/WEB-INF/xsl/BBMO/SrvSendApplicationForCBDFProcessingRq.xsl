...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/bbmo/10"
                xmlns:rsd="http://sbrf.ru/prpc/bbmo/10/SrvSendApplicationForCBDFProcessingRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name"
              select="//*[local-name()='Envelope' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='Body' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='SrvSendApplicationForCBDFProcessingRq' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/*[local-name()='NaturalPersonCompesationApplication' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/*[local-name()='ApplicationId' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/text()"/>
   <xsl:param name="dataFileName"
              select="'../../data/BBMO/xml/SrvSendApplicationForCBDFProcessingRqData.xml'"/>
...
<xsl:param name="correlation-id" select="''"/>
      ...
      <xsl:element name="soap:Envelope">
         <xsl:call-template name="KD4Header">
            ...
            <xsl:with-param name="operation-name"
                            select="string('SrvSendApplicationForCBDFProcessing')"/>
   ...
   <xsl:template match="rsd:SrvSendApplicationForCBDFProcessingRs">
      <tns:SrvSendApplicationForCBDFProcessingRs>
