...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/bbmo/10"
                xmlns:rsd="http://sbrf.ru/prpc/bbmo/10/SrvSendNaturalPersonApplicationStateChangeMessageRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name"
              select="//*[local-name()='Envelope' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='Body' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='SrvSendNaturalPersonApplicationStateChangeMessageRq' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/*[local-name()='NaturalPersonApplicationState' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/*[local-name()='ApplicationId' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/text()"/>
      ...
      <xsl:element name="soap:Envelope">
         <xsl:call-template name="KD4Header">
            ...
            <xsl:with-param name="operation-name"
                            select="string('SrvSendNaturalPersonApplicationProcessStageResult')"/>
