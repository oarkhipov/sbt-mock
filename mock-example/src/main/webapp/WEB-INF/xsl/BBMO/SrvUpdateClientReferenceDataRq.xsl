...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/bbmo/10"
                xmlns:rsd="http://sbrf.ru/prpc/bbmo/10/SrvUpdateClientReferenceDataRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name"
              select="//*[local-name()='Envelope' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='Body' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']/*[local-name()='SrvUpdateClientReferenceDataRq' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/*[local-name()='ChangeType' and namespace-uri()='http://sbrf.ru/prpc/bbmo/10']/text()"/>
