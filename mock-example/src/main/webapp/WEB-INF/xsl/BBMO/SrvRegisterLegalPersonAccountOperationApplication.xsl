...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/bbmo/10"
                xmlns:rsd="http://sbrf.ru/prpc/bbmo/10/SrvRegisterLegalPersonApplicationRs/Data/"
...
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
   <xsl:param name="name" select="//soap:Body/*//*[local-name()='TaxId'][1]/text()"/>
   <xsl:param name="dataFileName"
              select="'../../data/BBMO/xml/SrvRegisterLegalPersonAccountOperationApplicationData.xml'"/>
...
<xsl:param name="correlation-id" select="''"/>
   ...
   <xsl:template match="rsd:SrvRegisterLegalPersonApplicationRs">
