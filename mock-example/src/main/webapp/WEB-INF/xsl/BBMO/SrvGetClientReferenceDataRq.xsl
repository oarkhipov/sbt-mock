...
<xsl:param name="correlation-id" select="''"/>
   ...
   <xsl:template match="/">
      ...
      <xsl:element xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" name="soap:Envelope">
         <xsl:call-template name="KD4Header">
            ...
            <xsl:with-param name="operation-name" select="string('SrvGetClientReferenceData')"/>
         ...
         <soap:Body>
            <xsl:call-template name="SrvGetClientReferenceData">
   ...
   <xsl:template name="SrvGetClientReferenceData">
