...
<xsl:stylesheet xmlns:tns="http://sbrf.ru/prpc/bbmo/10"
                xmlns:rsd="http://sbrf.ru/prpc/bbmo/10/SrvPermitAccountChargeOperationRq/Data/"
...
<xsl:param name="correlation-id" select="''"/>
   ...
   <xsl:template match="rsd:SrvPermitAccountChargeOperationRq">
      <tns:SrvPermitAccountChargeOperationRq/>
   </xsl:template>
   ...
   <xsl:template name="SrvPermitAccountChargeOperationRq">
      ...
      <xsl:element name="tns:SrvPermitAccountChargeOperationRq">
         ...
         <tns:AccountNumber>
            <xsl:value-of select="$data/rsd:request[@name=$request]/rsd:AccountNumber"/>
         </tns:AccountNumber>
      </xsl:element>
   </xsl:template>
</xsl:stylesheet>
