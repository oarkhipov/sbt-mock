...
//    CRM testing
    ...
    @Test
    public void testGetPartisipantInfo2() throws Exception {
        testXSLT("GetParticipants", "Q.KKMB.FROM.CRMORG.SYNCRESP", "xml/CRM/GetParticipantInfo/rq2.xml", "xml/CRM/GetParticipantInfo/rs2.xml");
    }
