...
public class Xsl20TransformTest {
    ...
    public void testXMLDataRowToXMLDataListWithParam () throws Exception {
        ...
        String result = Xsl20Transformer.transform(XSLTFile, XMLFile, "name", "testError");
    ...
    public void testXMLDataRowToXMLDataListWithParam2 () throws Exception {
        ...
        String result = Xsl20Transformer.transform(XSLTFile, XMLFile, "name", "test1");
    ...
    public void testApplyRowToDataList () throws Exception {
        ...
        String result = Xsl20Transformer.transform(XSLTFile, XMLFile, "dataFile", "CRM\\xml\\ForceSignalData.xml");
    ...
    public void testApplyRowToDataList2 () throws Exception {
        ...
        String result = Xsl20Transformer.transform(XSLTFile, XMLFile, "dataFile", "AMRLiRT\\xml\\SrvCalcDebtCapacityData.xml");
